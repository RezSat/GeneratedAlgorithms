...
-   [Prime Shift Cipher](posts/prime-shift-cipher.md) - [Download Python Code](posts/prime-shift-cipher.py)
- [Weighted Random Walk](posts/weighted-random-walk.md) - [Download Python Code](posts/weighted-random-walk.py)
- [Cyclic Cellular Automaton](posts/cyclic-cellular-automaton.md) - [Download Python Code](posts/cyclic-cellular-automaton.py)
